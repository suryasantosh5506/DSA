<h2><a href="https://leetcode.com/problems/minimum-processing-time/?envType=problem-list-v2&envId=greedy">3151. Minimum Processing Time</a></h2><h3>Medium</h3><hr><p>You have a certain number of processors, each having 4 cores. The number of tasks to be executed is four times the number of processors. Each task must be assigned to a unique core, and each core can only be used once.</p>
