<h2><a href="https://leetcode.com/problems/string-compression-iii/description/">3451. String Compression III</a></h2><h3>Medium</h3><hr><p>Given a string <code>word</code>, compress it using the following algorithm:</p>
