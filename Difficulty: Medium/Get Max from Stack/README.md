<h2><a href="https://www.geeksforgeeks.org/problems/get-max-from-stack/1?utm_source=chatgpt.com">Get Max from Stack</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18.6667px;">Implement a class <strong>SpecialStack</strong> that supports following operations:</span></p>
<ul>
